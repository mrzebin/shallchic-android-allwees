...
public class CheckView extends View implements Checkable {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mSize = ta.getDimensionPixelSize(R.styleable.CheckView_ev_size, QMUIDisplayHelper.dp2px(getContext(),18));
        mType = ta.getInt(R.styleable.CheckView_ev_type, TYPE_CIRCLE);

        mStrokeWidth = ta.getDimensionPixelSize(R.styleable.CheckView_ev_strokeWidth, QMUIDisplayHelper.dp2px(getContext(),18));
