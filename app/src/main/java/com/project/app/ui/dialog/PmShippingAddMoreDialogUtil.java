 ...
 * pay choice method
 */
public class PmShippingAddMoreDialogUtil {
    ...
    public PmShippingAddMoreDialogUtil(Context context, boolean isCancelable, boolean iscancelOutside){
    ...
    public void hintExtrasMoney(String hintMsg) {
        tv_shopAddMore.setText(hintMsg);
    }
