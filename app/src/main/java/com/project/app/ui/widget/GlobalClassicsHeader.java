...
public class GlobalClassicsHeader extends LinearLayout implements RefreshHeader {
    ...
    public GlobalClassicsHeader(Context context, @Nullable AttributeSet attrs) {
        ...
        mHeaderText.setTextColor(getResources().getColor(R.color.color_333));
        mProgressDrawable = new ProgressDrawable();
        mProgressDrawable.setColor(getResources().getColor(R.color.color_333));
        mArrowView    = new ImageView(context);
        mProgressView = new ImageView(context);
        mProgressView.setImageDrawable(mProgressDrawable);
//        mArrowView.setImageDrawable(new ArrowDrawable());
        mArrowView.setImageResource(R.mipmap.ic_loading_arrow);
        addView(mProgressView, SmartUtil.dp2px(20), SmartUtil.dp2px(20));
//        addView(mArrowView, SmartUtil.dp2px(20), SmartUtil.dp2px(25));
        addView(mArrowView);
        addView(new Space(context), SmartUtil.dp2px(10), SmartUtil.dp2px(10));
