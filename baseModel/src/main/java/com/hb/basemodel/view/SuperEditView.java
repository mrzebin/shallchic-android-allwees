...
public class SuperEditView extends LinearLayout {
    ...
    public SuperEditView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        defaultMargin = Unit.sp2px(context, defaultMargin);
        initAttrs(attrs);
        initPaint();
        initView();
    }
    ...
    private void initSuperEditText() {
        ...
        setPadding(Unit.dp2px(mContext, 5), 0,0, 0);
    }
    ...
    private void initEdit() {
        ...
        editText.setTextDirection(LAYOUT_DIRECTION_LTR);
...
//                }
    ...
    private void initClearIcon() {
        ...
        clearParams.setMarginStart(Unit.dp2px(mContext,5));
    ...
    private void initHideShowSwitch() {
        ...
        LayoutParams switchParams = new LinearLayout.LayoutParams(Unit.dp2px(mContext,20), Unit.dp2px(mContext,15));
        hideShowSwitchIv.setId(R.id.sHideShowSwitchIv);
        hideShowSwitchIv.setLayoutParams(switchParams);

        if (hideIconSrc == null) {
            hideIconSrc = mContext.getResources().getDrawable(R.drawable.ic_password_hid);
        }
        if (showIconSrc == null) {
            showIconSrc = mContext.getResources().getDrawable(R.drawable.ic_password_show);
        }
